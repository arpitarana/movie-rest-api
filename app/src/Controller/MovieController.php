...
class MovieController extends AbstractFOSRestController
{
     ...
     * @return Response
     */
    public function createMovie(Movies $movie, ConstraintViolationListInterface $validationErrors, MailManager $mailManager)
    {
        ...
        $mailManager->sendEmail($this->getUser(), $movie);
